import numpy as np
import torch
from utils import TSP_2opt, construct_tsp_from_mst, check_for_intersection, make_tours, batched_two_opt_torch
...
def tsp_constraint():
    ...
    def _fn(points, model_latent, dists, constraint_type=None, constraint=None, max_iter=1000):
        if constraint_type == 'basic':
            ...
            solved_tours, _ = batched_two_opt_torch(
                ...
                max_iterations=max_iter, device=model_latent.device)
